...
def n4_correction(im_input):
    command = 'N4BiasFieldCorrection -d 3 -i ' + im_input + ' ' + ' -s 3 -c [50x50x30x20] -b [300] -o ' + im_input.replace(
        '.nii.gz', '_corrected.nii.gz')
    os.system(command)
...
if __name__ == '__main__':
 ...
 # Use n4_correction for to correct the MRIs, you can use the code below
# python n4correction.py ../dataset/Brats2018/MICCAI_BraTS_2018_Data_Validation
