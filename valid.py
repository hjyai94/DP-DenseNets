...
import numpy as np
from model.HyperDenseNet import HyperDenseNet
...
def visualize_result(name, pred, args):
    ...
    nib.save(pred, args.result + '/' + args.id + '/' + str(args.num_round) + '/' + str(name) + '.nii.gz')
...
def main(args):
    ...
    # import network architecture
    model = HyperDenseNet(args.num_classes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--id', default='HyperDenseNet',
